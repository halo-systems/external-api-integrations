#!/bin/bash
# Script to get network device information from HaloWiFi
...
API_URL="https://one.halowifi.com/api/external/location/${LOCATION_ID}/networking-device/${NETWORKING_DEVICE_ID}"
